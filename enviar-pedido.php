<?php
    $title_pedido_recebido = "Pedido Recebido";
...
<head>
	<meta charset="utf-8">
	<title><?=$title_pedido_recebido;?></title>
    ...
    <main>
        <div id="main_dados">
            ...
            <div id="main_caixa_dados">
                <h1>Recebendo dados do pedido com:</h1>
                <?php
                echo "<p>Nome: $nome <br> Endereço: $endereco <br> Email: $email <br> Telefone: $telefone <br> Descrição: $descricao</p>";
                ?>;
            </div>
        </div>
    </main>
